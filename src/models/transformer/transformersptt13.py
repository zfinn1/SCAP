...
from models.transformer.PointTreeAttention2 import PTA2, PTA_cross, Mlp, ONE_BATCH
...
class Tree_TransformerLayer(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        if attention_type == 'dot_prod':
            self.self_attn = PTA2(nhead, in_dim=d_model, dim=d_model, topks=[8,8,8], knn_k=self.knn_k)
